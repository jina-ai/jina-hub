...
def test_bimatchranker():
    ...
    query_chunk2match_chunk = {
        100: [
            {'parent_id': 1, 'id': 10, 'score': 0.4, 'siblings': 200},
        ],
        110: [
            {'parent_id': 1, 'id': 10, 'score': 0.3, 'siblings': 200},
            {'parent_id': 1, 'id': 11, 'score': 0.2, 'siblings': 200},
            {'parent_id': 4294967294, 'id': 20, 'score': 0.1, 'siblings': 300},
        ]
    }
    """
    ranker = BiMatchRanker()
    query_chunk_meta = {'100': {'siblings': 2}, '110': {'siblings': 2}}
    match_chunk_meta = {'10': {'siblings': 200}, '11': {'siblings': 200}, '20': {'siblings': 300}}
...
def test_bimatchranker_readme():
    ...
    query_chunk2match_chunk = {
    1: [
        {'parent_id': 1, 'id': 11, 'score': 0.1, 'siblings': 4},
        {'parent_id': 2, 'id': 22, 'score': 0.5, 'siblings': 3},
        {'parent_id': 2, 'id': 21, 'score': 0.7, 'siblings': 3},
    ],
    2: [
        {'parent_id': 2, 'id': 21, 'score': 0.1, 'siblings': 3},
        {'parent_id': 1, 'id': 11, 'score': 0.5, 'siblings': 4},
        {'parent_id': 2, 'id': 22, 'score': 0.7, 'siblings': 3},
    ],
    3: [
        {'parent_id': 2, 'id': 21, 'score': 0.1, 'siblings': 3},
        {'parent_id': 2, 'id': 22, 'score': 0.5, 'siblings': 3},
        {'parent_id': 2, 'id': 23, 'score': 0.7, 'siblings': 3},
    ]
    }
    """
    ranker = BiMatchRanker(d_miss=1)
    query_chunk_meta = {'1': {'siblings': 3}, '2': {'siblings': 3}, '3': {'siblings': 3}}
    match_chunk_meta = {'11': {'siblings': 4}, '22': {'siblings': 3}, '21': {'siblings': 3}, '23': {'siblings': 3}}
    # test score() with fake grouped data
